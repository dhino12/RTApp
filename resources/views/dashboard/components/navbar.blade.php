    ...
    <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
        <nav>
            ...
            <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                ...
                <li class="text-sm pl-2 capitalize leading-normal text-slate-700" aria-current="page">
                    {{ Request::getRequestUri() }}
                </li>
            </ol>
            <h6 class="mb-0 font-bold capitalize">{{ last(request()->segments()) }}</h6>
        </nav>
        <div class="flex flex-col md:flex-row items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
            ...
            <ul class="flex flex-row justify-center md:justify-end pl-0 mb-0 list-none md-max:w-full">
                <!-- online builder btn  -->
