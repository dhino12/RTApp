            ...
            <div id="profile" class="flex flex-col gap-5 p-5 mb-8 bg-white shadow-xl shadow-slate-100 rounded-xl">
                ...
                <form action="/dashboard/about/{{ $about->id }}" enctype="multipart/form-data" method="post" class="flex justify-center flex-col my-5 gap-5 w-full">
                    ...
                    <span class="w-full">
                        ...
                        <img alt="" class="img-preview hidden my-2 md:h-full card-hover rounded-2xl sm:bg-red-200 md:max-h-[50vh] shadow-lg shadow-slate-300">
                        <input
                            class="form-control block mt-8 @error('image') @enderror"
                            type="file"
                            id="image" 
                            name="image"
