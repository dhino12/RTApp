    ...
    <div class="flex flex-wrap my-6 -mx-3 overflow-hidden">
        ...
        <div class="flex-none w-full max-w-full px-3">
            ...
            <div class="relative flex flex-col min-w-0 max-w-20 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                <a href="/dashboard/documents/create" class="bg-gradient-to-tl from-cyan-400 to-blue-400 active:scale-[0.95] transition-all hover:scale-[1.05] px-2.5 text-sm rounded-1.8 py-2.2 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white">
                    Tambah
                </a>
            </div>
            <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                    <h6 class="font-bold">Data & Laporan Table</h6>
                </div>
